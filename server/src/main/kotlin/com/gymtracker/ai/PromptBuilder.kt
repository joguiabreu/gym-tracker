...
""".trimIndent()
    ...
    fun buildResuggestMessage(
        ...
        rejected: List<RejectedExercise>
    ): String {
        ...
        rejected.forEach { parts.add("- ${it.name} — reason: ${it.reason}") }
...
{"week_start":"YYYY-MM-DD","days":[{"day_of_week":"Monday","focus":"Chest/Triceps","completed":false},...]}
...
""".trimIndent()
    ...
    fun buildWeeklySummaryPrompt(sessions: List<SessionData>): String {
        ...
        parts.add("\nReturn ONLY JSON: {\"week_start\":\"YYYY-MM-DD\",\"text\":\"summary here\"}")
        return parts.joinToString("\n")
    }
